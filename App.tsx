...
export default function App() {
  ...
  return (
    <div className={`w-full overflow-x-hidden ${activeTab === 'dashboard' && user.role === 'pt' ? 'lg:h-screen lg:overflow-hidden min-h-screen' : 'min-h-screen pb-24'} flex flex-col transition-colors duration-500 ${theme === 'dark' ? 'bg-black text-white' : 'bg-zinc-50 text-zinc-900'}`}>
      {/* Header */}
      ...
      {/* Content */}
      <main className={`max-w-7xl mx-auto flex-1 w-full ${activeTab === 'dashboard' && user.role === 'pt' ? 'px-4 py-4 flex flex-col min-h-0 lg:overflow-hidden overflow-y-auto lg:pb-8 pb-40' : 'px-4 py-8 overflow-y-auto pb-32'}`}>
